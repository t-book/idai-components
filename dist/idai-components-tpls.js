...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('partials/layout/idai-footer.html',
    '<style>\n' +
    '    #footer .row {\n' +
    '        padding-bottom: 10px;\n' +
    '    }\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('partials/layout/idai-form.html',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('partials/layout/idai-header.html',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('partials/messages/idai-message.html',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('partials/picker/idai-country-picker.html',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('partials/picker/idai-picker.html',
