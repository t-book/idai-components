...
1. The language selection rule [specification](https://github.com/codarchlab/arachnefrontend/blob/master/docs/feature_localization_con10t.md)
1. The language selection rule [code](../src/js/services_language_selection.js)
1. The data structure handling [code](../src/js/services_localized_content.js)
1. The browsers language determination [code](../src/js/services_language.js)

Here are further artifacts using the core components:

1. The content delivery [code](../src/js/controllers_static_content.js)
1. The navbar [code](../js/src/directives_navbar.js)
1. The footer [code](../js/src/directives_footer.js)
1. The projects overview [code](../src/js/controllers_projects.js)
